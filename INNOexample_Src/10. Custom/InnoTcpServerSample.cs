//================================================================================
//
// _INNO._Net.InnoNetTcpServerSample
//
//================================================================================
...
//--------------------------------------------------------------------------------
// [설명]
// 1. TCP Server Sample Class
//--------------------------------------------------------------------------------
// [이력]
// <날짜>    <작성자>    <설명>
// 23-03-17  Andy Yang  Initial Version. (간단히 사용하기 위한 목적의 TcpClientServer)
...
namespace _Custom
{
    ...
    /// </summary>
    public class InnoTcpServerSample : InnoTcpBase
    {
        //##
        ...
        protected override void OnInfo(object sender, InnoNetTcpInfoEventArgs e)
        {
            ...
            string uiMsg = $"[{dtNow}][Server] Code={e.Code} Message={e.Message}";
            _uiQueue.Push(uiMsg);
        ...
        protected override void OnError(object sender, InnoNetTcpErrorEventArgs e)
        {
            // UI queue
            string dtNow = DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss.fff");
            string uiMsg = $"[{dtNow}][Server.Error] Code={e.Code} Message={e.Message}";
            _uiQueue.Push(uiMsg);
